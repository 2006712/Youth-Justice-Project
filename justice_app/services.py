...
def get_all_youth_records():
    ...
    Keeps query logic outside views.py.
    """
...
def generate_support_recommendations(youth):
    """
    Generate support program recommendations and explanation reasons
    for a selected youth.
    """
    try:
        ...
        raise RecommendationGenerationError(
            f"Unable to generate support recommendations: {str(error)}"
        )